 ...
 */ (function (e) {
  ...
  function r(x) {
    ...
    if (T !== z) {
      x[0] = T;
      e: for (var W = 0, Z = x.length, er = Z >>> 1; W < er; ) {
        var gn = 2 * (W + 1) - 1,
          wl = x[gn],
          wn = gn + 1,
          nr = x[wn];
        if (0 > l(wl, T))
          wn < Z && 0 > l(nr, wl)
            ? ((x[W] = nr), (x[wn] = T), (W = wn))
            : ((x[W] = wl), (x[gn] = T), (W = gn));
        else if (wn < Z && 0 > l(nr, T)) (x[W] = nr), (x[wn] = T), (W = wn);
        else break e;
      }
    }
    return z;
  ...
  function h(x) {
    if (((w = !1), c(x), !k))
      if (t(s) !== null) (k = !0), yl(E);
        ...
        var z = t(d);
        z !== null && gl(h, z.startTime - x);
      }
  }
  function E(x, z) {
    (k = !1), w && ((w = !1), f(N), (N = -1)), (g = !0);
    var T = p;
    try {
      for (
        c(z), m = t(s);
      ...
      if (m !== null) var er = !0;
        ...
        var gn = t(d);
        gn !== null && gl(h, gn.startTime - z), (er = !1);
      }
      return er;
    } finally {
      (m = null), (p = T), (g = !1);
      ...
      return (
        ...
        T > W
          ? ((x.sortIndex = T),
            ...
            t(s) === null &&
              x === t(d) &&
              (w ? (f(N), (N = -1)) : (w = !0), gl(h, T - W)))
          : ((x.sortIndex = Z), n(s, x), k || g || ((k = !0), yl(E))),
        x
      );
    }),
...
var Fr = null;
function fo(e, n, t, r) {
  if (((Fr = null), (e = Zo(r)), (e = En(e)), e !== null))
...
var it = {
  ...
  rl = B({}, Jt, {
    ...
    movementX: function (e) {
      return "movementX" in e
        ...
        : (e !== vt &&
            (vt && e.type === "mousemove"
              ? ((Nl = e.screenX - vt.screenX), (Pl = e.screenY - vt.screenY))
              : (Pl = Nl = 0),
            (vt = e)),
          Nl);
    },
  ...
  Ju = Se(rl),
  sf = B({}, rl, { dataTransfer: 0 }),
  af = Se(sf),
  cf = B({}, Jt, { relatedTarget: 0 }),
  zl = Se(cf),
  ff = B({}, it, { animationName: 0, elapsedTime: 0, pseudoElement: 0 }),
  df = Se(ff),
  pf = B({}, it, {
...
var kf = B({}, Jt, {
  ...
  Cf = Se(xf),
  _f = B({}, it, { propertyName: 0, elapsedTime: 0, pseudoElement: 0 }),
  Nf = Se(_f),
  Pf = B({}, rl, {
    deltaX: function (e) {
...
function Of(e, n) {
  if (Fn)
    return e === "compositionend" || (!lu && As(e, n))
      ? ((e = Fs()), (Er = nu = tn = null), (Fn = !1), e)
      : null;
  switch (e) {
    case "paste":
      return null;
...
function $s(e) {
  if (e.propertyName === "value" && ll(Ut)) {
    var n = [];
    Bs(n, Ut, e, Zo(e)), Es(Df, n);
  }
}
function jf(e, n, t) {
  e === "focusin"
    ? (li(), (Nt = n), (Ut = t), Nt.attachEvent("onpropertychange", $s))
    : e === "focusout" && li();
}
function Ff(e) {
  ...
  Es(function () {
    ...
    e: {
      ...
      if (p !== void 0) {
        ...
        for (var a = d, c; a !== null; ) {
          ...
          if (
            (c.tag === 5 &&
              h !== null &&
              ((c = h),
              f !== null && ((h = Dt(a, f)), h != null && w.push(Bt(a, h, c)))),
            D)
          )
            break;
          a = a.return;
        ...
        0 < w.length &&
          ((p = new g(p, k, null, t, v)), m.push({ event: p, listeners: w }));
      }
    }
    if (!(n & 7)) {
      e: {
        ...
        if (
          ...
          if (
            ...
            n: {
              for (w = g, f = k, a = 0, c = w; c; c = Dn(c)) a++;
              for (c = 0, h = f; h; h = Dn(h)) c++;
              for (; 0 < a - c; ) (w = Dn(w)), a--;
              for (; 0 < c - a; ) (f = Dn(f)), c--;
              for (; a--; ) {
...
function yn() {
  if (!Fl && Qe !== null) {
    ...
    try {
      ...
      throw (Qe !== null && (Qe = Qe.slice(e + 1)), Ns(Jo, yn), l);
    } finally {
      (I = n), (Fl = !1);
    }
  }
...
var Qn = [],
  ...
  He = "";
function kn(e, n) {
  (Qn[$n++] = $r), (Qn[$n++] = Qr), (Qr = e), ($r = n);
}
function ta(e, n, t) {
  (Ee[xe++] = $e), (Ee[xe++] = He), (Ee[xe++] = zn), (zn = e);
  var r = $e;
  e = He;
  var l = 32 - Ie(r) - 1;
  (r &= ~(1 << l)), (t += 1);
...
function iu(e) {
  for (; e === Qr; )
    (Qr = Qn[--$n]), (Qn[$n] = null), ($r = Qn[--$n]), (Qn[$n] = null);
  for (; e === zn; )
    (zn = Ee[--xe]),
      (Ee[xe] = null),
      (He = Ee[--xe]),
  ...
  switch (e.tag) {
    ...
    case 13:
      return (
        ...
        n !== null
          ? ((t = zn !== null ? { id: $e, overflow: He } : null),
            (e.memoizedState = {
              dehydrated: n,
              treeContext: t,
...
function Kr(e, n, t, r) {
  ...
  if (i !== null) {
    ...
    v !== null &&
      ...
      (i = v.lastBaseUpdate),
      i !== u &&
        (i === null ? (v.firstBaseUpdate = d) : (i.next = d),
        (v.lastBaseUpdate = s)));
  }
  if (o !== null) {
    var m = l.baseState;
...
function _o(e, n, t, r) {
  var l = e.stateNode;
  (l.props = t), (l.state = e.memoizedState), (l.refs = ia), pu(e);
  var o = n.contextType;
  typeof o == "object" && o !== null
    ? (l.context = Ne(o))
    : ((o = me(n) ? Pn : oe.current), (l.context = et(e, o))),
...
function aa(e) {
      ...
      : a !== null &&
        (a.elementType === E ||
          (typeof E == "object" &&
            ...
            E.$$typeof === qe &&
            Ei(E) === a.type))
      ? ((h = l(a, c.props)), (h.ref = ht(f, a, c)), (h.return = f), h)
      : ((h = Lr(c.type, c.key, c.props, null, f.mode, h)),
        (h.ref = ht(f, a, c)),
        (h.return = f),
        h);
  }
  function d(f, a, c, h) {
    return a === null ||
      ...
      ? ((a = Wl(c, f.mode, h)), (a.return = f), a)
      : ((a = l(a, c.children || [])), (a.return = f), a);
  }
  function v(f, a, c, h, E) {
    return a === null || a.tag !== 7
      ? ((a = Nn(c, f.mode, h, E)), (a.return = f), a)
      : ((a = l(a, c)), (a.return = f), a);
  }
  function m(f, a, c) {
    if ((typeof a == "string" && a !== "") || typeof a == "number")
      return (a = Hl("" + a, f.mode, c)), (a.return = f), a;
    if (typeof a == "object" && a !== null) {
      switch (a.$$typeof) {
        case rr:
          return (
            (c = Lr(a.type, a.key, a.props, null, f.mode, c)),
            (c.ref = ht(f, null, a)),
            (c.return = f),
            c
          );
        case Mn:
          return (a = Wl(a, f.mode, c)), (a.return = f), a;
        case qe:
          var h = a._init;
          return m(f, h(a._payload), c);
      }
      if (kt(a) || ft(a))
        return (a = Nn(a, f.mode, c, null)), (a.return = f), a;
      mr(f, a);
    }
    return null;
  }
  function p(f, a, c, h) {
    ...
    if (typeof c == "object" && c !== null) {
      ...
      if (kt(c) || ft(c)) return E !== null ? null : v(f, a, c, h, null);
      mr(f, c);
    }
    return null;
  }
  function g(f, a, c, h, E) {
    if ((typeof h == "string" && h !== "") || typeof h == "number")
      return (f = f.get(c) || null), i(a, f, "" + h, E);
    if (typeof h == "object" && h !== null) {
      switch (h.$$typeof) {
        ...
        case qe:
          var C = h._init;
          return g(f, a, c, C(h._payload), E);
      }
      if (kt(h) || ft(h)) return (f = f.get(c) || null), v(a, f, h, E, null);
      mr(a, h);
    }
    return null;
  }
  function k(f, a, c, h) {
    ...
    if (N === c.length) return t(f, _), U && kn(f, N), E;
    if (_ === null) {
      for (; N < c.length; N++)
        (_ = m(f, c[N], h)),
          _ !== null &&
  ...
  function w(f, a, c, h) {
    ...
    for (
      var C = (E = null), _ = a, N = (a = 0), H = null, R = c.next();
      _ !== null && !R.done;
      N++, R = c.next()
    ) {
      _.index > N ? ((H = _), (_ = null)) : (H = _.sibling);
      var ze = p(f, _, R.value, h);
      if (ze === null) {
        _ === null && (_ = H);
        break;
      }
    ...
    if (R.done) return t(f, _), U && kn(f, N), E;
    if (_ === null) {
      for (; !R.done; N++, R = c.next())
        (R = m(f, R.value, h)),
          R !== null &&
            ((a = o(R, a, N)), C === null ? (E = R) : (C.sibling = R), (C = R));
      return U && kn(f, N), E;
    }
    for (_ = r(f, _); !R.done; N++, R = c.next())
      (R = g(_, f, N, R.value, h)),
        R !== null &&
      ...
      switch (c.$$typeof) {
        case rr:
          e: {
            ...
            c.type === jn
              ? ((a = Nn(c.props.children, f.mode, h, c.key)),
                (a.return = f),
                (f = a))
              : ((h = Lr(c.type, c.key, c.props, null, f.mode, h)),
                (h.ref = ht(f, a, c)),
        ...
        case Mn:
          e: {
            ...
            (a = Wl(c, f.mode, h)), (a.return = f), (f = a);
          }
          return u(f);
        case qe:
          return (C = c._init), D(f, a, C(c._payload), h);
      }
      if (kt(c)) return k(f, a, c, h);
      if (ft(c)) return w(f, a, c, h);
      mr(f, c);
    }
    return (typeof c == "string" && c !== "") || typeof c == "number"
      ? ((c = "" + c),
        a !== null && a.tag === 6
          ...
          : (t(f, a), (a = Hl(c, f.mode, h)), (a.return = f), (f = a)),
        u(f))
      : t(f, a);
  }
  return D;
...
function mu(e, n) {
  switch ((M(Ht, n), M($t, e), M(Ve, bt), (e = n.nodeType), e)) {
    case 9:
    case 11:
...
function Na(e, n, t) {
  return Tn & 21
    ? (Me(t, n) || ((t = Ts()), (V.lanes |= t), (Ln |= t), (e.baseState = !0)),
      n)
...
function ld(e, n, t) {
  ...
  if (za(e)) Ta(n, l);
    ...
    (t = oa(e, n, l, r)),
      t !== null && ((l = se()), De(t, e, r, l), La(t, n, r));
  }
}
function za(e) {
  var n = e.alternate;
...
function Li(e, n, t, r, l) {
  ...
  if ((Jn(n, l), n.stateNode === null))
    ...
    (u = n.stateNode),
      ua(e, n),
      (i = n.memoizedProps),
      (d = n.type === n.elementType ? i : Le(n.type, i)),
      (u.props = d),
      (m = n.pendingProps),
      (p = u.context),
      (s = t.contextType),
    ...
    i !== m || p !== k || pe.current || be
      ? (typeof g == "function" && (Co(n, t, g, r), (k = n.memoizedState)),
        (d = be || ki(n, t, d, r, p, k, s) || !1)
          ? (v ||
...
function zo(e, n, t, r, l, o) {
  Ma(e, n);
  var u = (n.flags & 128) !== 0;
  if (!r && !u) return l && vi(n, t, !1), Ge(e, n, o);
...
function Ri(e, n, t, r, l) {
  return nt(), su(l), (n.flags |= 256), ie(e, n, t, r), n.child;
}
...
function Fa(e, n, t) {
  ...
  if (o) {
    ...
    return (
      ...
      i !== null ? (o = dn(i, o)) : ((o = Nn(o, u, t, null)), (o.flags |= 2)),
      (o.return = n),
      (r.return = n),
      (r.sibling = o),
      (n.child = r),
...
function cd(e, n, t, r, l, o, u) {
  if (t)
    return n.flags & 256
      ? ((n.flags &= -257), (r = Ql(Error(y(422)))), vr(e, n, u, r))
      : n.memoizedState !== null
  ...
  if (l.data === "$!") {
    ...
    return (r = i), (o = Error(y(419))), (r = Ql(o, r, void 0)), vr(e, n, u, r);
  }
  if (((i = (u & e.childLanes) !== 0), de || i)) {
    if (((r = q), r !== null)) {
      ...
      (l = l & (r.suspendedLanes | u) ? 0 : l),
        l !== 0 &&
          l !== o.retryLane &&
          ((o.retryLane = l), Xe(e, l), De(r, e, l, -1));
    }
    return zu(), (r = Ql(Error(y(421)))), vr(e, n, u, r);
  }
  return l.data === "$?"
    ? ((n.flags |= 128),
      (n.child = e.child),
  ...
  switch ((iu(n), n.tag)) {
    ...
    case 6:
      if (e && n.stateNode != null) Ba(e, n, e.memoizedProps, r);
        ...
        if (((t = Cn(Ht.current)), Cn(Ve.current), pr(n))) {
          if (
            ((r = n.stateNode),
            (t = n.memoizedProps),
            (r[Ue] = n),
      ...
      return n.flags & 128
        ...
        : ((r = r !== null),
          r !== (e !== null && e.memoizedState !== null) &&
            ...
            ((n.child.flags |= 8192),
            n.mode & 1 &&
              (e === null || A.current & 1 ? G === 0 && (G = 3) : zu())),
          n.updateQueue !== null && (n.flags |= 4),
          re(n),
          null);
    case 4:
      return (
        rt(), Ro(e, n), e === null && Vt(n.stateNode.containerInfo), re(n), null
      );
    case 10:
    ...
    case 17:
      return me(n.type) && Vr(), re(n), null;
    case 19:
      if ((F(A), (o = n.memoizedState), o === null)) return re(n), null;
...
function Qa(e) {
  ...
  n !== null && ((e.alternate = null), Qa(n)),
    ...
    e.tag === 5 &&
      ((n = e.stateNode),
      n !== null &&
        (delete n[Ue], delete n[Qt], delete n[wo], delete n[Jf], delete n[qf])),
    (e.stateNode = null),
    (e.return = null),
    (e.dependencies = null),
...
function Wa(e, n) {
  ...
  switch (e.tag) {
    ...
    case 15:
      ...
      break;
    case 1:
      Te(n, e), je(e), r & 512 && t !== null && Wn(t, t.return);
      break;
    case 5:
      if (
        (Te(n, e),
    ...
    case 3:
      if (
        (Te(n, e), je(e), r & 4 && t !== null && t.memoizedState.isDehydrated)
      )
        try {
          Ft(n.containerInfo);
        } catch (w) {
    ...
    case 22:
      if (
        ...
        e.mode & 1 ? ((le = (d = le) || v), Te(n, e), (le = d)) : Te(n, e),
        je(e),
        r & 8192)
      ) {
        if (
...
function De(e, n, t, r) {
  ...
  Zt(e, t, r),
    (!(O & 2) || e !== q) &&
      (e === q && (!(O & 2) && (fl |= t), G === 4 && nn(e, ee)),
      ve(e, r),
      t === 1 && O === 0 && !(n.mode & 1) && ((ot = K() + 500), il && yn()));
}
function ve(e, n) {
  ...
  if (r === 0)
    ...
    if ((t != null && Yu(t), n === 1))
      e.tag === 0 ? bf(Ai.bind(null, e)) : na(Ai.bind(null, e)),
        Gf(function () {
          !(O & 6) && yn();
        }),
        (t = null);
...
function Ya(e, n) {
  if (((zr = -1), (Tr = 0), O & 6)) throw Error(y(327));
  var t = e.callbackNode;
  ...
  if (n !== 0) {
    if (
      ...
      throw ((t = Xt), _n(e, 0), nn(e, r), ve(e, K()), t);
    if (n === 6) nn(e, r);
    else {
      if (
      ...
      switch (((e.finishedWork = l), (e.finishedLanes = r), n)) {
        ...
        case 3:
          if (
            (nn(e, r), (r & 130023424) === r && ((n = _u + 500 - K()), 10 < n))
          ) {
            if (Mr(e, 0) !== 0) break;
            ...
            e.timeoutHandle = go(Sn.bind(null, e, fe, Be), n);
            break;
          }
          Sn(e, fe, Be);
          break;
        case 4:
          ...
          if (
            ...
            e.timeoutHandle = go(Sn.bind(null, e, fe, Be), r);
            break;
          }
          Sn(e, fe, Be);
          break;
  ...
  return ve(e, K()), e.callbackNode === t ? Ya.bind(null, e) : null;
}
function Uo(e, n) {
  var t = Lt;
  return (
...
function Ai(e) {
  ...
  if (t === 1) throw ((t = Xt), _n(e, 0), nn(e, n), ve(e, K()), t);
...
function Rn(e) {
  ...
  try {
    ...
    (I = r), (_e.transition = t), (O = n), !(O & 6) && yn();
  }
}
function Pu() {
  (he = Kn.current), F(Kn);
...
function br(e, n) {
  ...
  while (!0);
  if ((cu(), (O = t), (Zr.current = r), Y !== null)) throw Error(y(261));
...
function Sn(e, n, t) {
  var r = I,
    l = _e.transition;
  try {
    (_e.transition = null), (I = 1), Sd(e, n, t, r);
  } finally {
    (_e.transition = l), (I = r);
  }
  return null;
  ...
  if (rn !== null) {
    ...
    try {
      if (((_e.transition = null), (I = 16 > e ? 16 : e), rn === null))
        ...
        if (((e = rn), (rn = null), (qr = 0), O & 6)) throw Error(y(331));
        var l = O;
        ...
        for (S = a; S !== null; ) {
          u = S;
          var c = u.child;
          if (u.subtreeFlags & 2064 && c !== null) (c.return = u), (S = c);
          else
            e: for (u = a; S !== null; ) {
              if (((i = S), i.flags & 2048))
                try {
...
function qa(e, n) {
  n === 0 &&
    (e.mode & 1
      ...
      : (n = 1));
  var t = se();
  (e = Xe(e, n)), e !== null && (Zt(e, n, t), ve(e, t));
}
function xd(e) {
  var n = e.memoizedState,
    t = 0;
...
ba = function (e, n, t) {
  ...
  else (de = !1), U && n.flags & 1048576 && ta(n, $r, n.index);
      ...
      return (
        ...
        l.$$typeof === void 0
          ? ((n.tag = 1),
            ...
            _o(n, r, e, t),
            (n = zo(null, n, r, !0, o, t)))
          : ((n.tag = 0), U && o && uu(n), ie(null, n, l, t), (n = n.child)),
        n
      );
    case 16:
      r = n.elementType;
...
function Lr(e, n, t, r, l, o) {
  ...
  if (((r = e), typeof e == "function")) Tu(e) && (u = 1);
    ...
    e: switch (e) {
      ...
      case Xl:
        return (
          (e = Ce(12, t, n, l | 2)), (e.elementType = Xl), (e.lanes = o), e
        );
      case Gl:
        return (e = Ce(13, t, n, l)), (e.elementType = Gl), (e.lanes = o), e;
      case Zl:
        return (e = Ce(19, t, n, l)), (e.elementType = Zl), (e.lanes = o), e;
      case as:
        return dl(t, l, o, n);
      default:
...
function Ld(e, n, t, r, l) {
  ...
  var s = Lu(e, 0, !1, null, null, !1, !1, "", Qi);
  return (
  ...
  switch (e.tag) {
    case 3:
      ...
      if (n.current.memoizedState.isDehydrated) {
        ...
        t !== 0 &&
          (qo(n, t | 1), ve(n, K()), !(O & 6) && ((ot = K() + 500), yn()));
      }
      break;
    case 13:
      Rn(function () {
...
ks = Nu;
Ss = Rn;
var Rd = { usingClientEntryPoint: !1, Events: [qt, Vn, ul, gs, ws, Nu] },
  gt = {
...
const Hi = "/assets/circle-B2nAor_y.png",
  Wi =
    "data:image/png;base64,";
let P = ["", "", "", "", "", "", "", "", ""];
const Dd = () => {
  let e = ue.useRef(null),
    n = ue.useRef(null),
    t = ue.useRef(null),
    r = ue.useRef(null),
    l = ue.useRef(null),
    ...
    s = ue.useRef(null),
    d = [e, n, t, r, l, o, u, i, s];
  const [v, m] = ue.useState(!1);
  let [p, g] = ue.useState(0),
    k = ue.useRef(null);
  const w = (c, h) => {
      if (v == !0) return 0;
      p % 2 === 0
        ? ((c.target.innerHTML = ` <img src='${Wi}' alt="nothing" /> `),
          (P[h] = "x"),
          g(++p))
        : ((c.target.innerHTML = ` <img src='${Hi}' alt="nothing" /> `),
          (P[h] = "o"),
          g(++p)),
        D();
    },
    D = () => {
      P[0] === P[1] && P[1] === P[2] && P[2] !== ""
        ...
        : (P[2] === P[5] && P[5] === P[8] && P[8] !== "") ||
          (P[0] === P[4] && P[4] === P[8] && P[8] !== "")
        ? f(P[8])
        : P[2] === P[4] && P[4] === P[6] && P[6] !== "" && f(P[6]);
    },
    f = (c) => {
      m(!0),
        c === "x"
          ? (k.current.innerHTML = `Congratulations <img src='${Wi}' alt="nothing" /> wins`)
          : (k.current.innerHTML = `Congratulations <img src='${Hi}' alt="nothing" /> wins`);
    },
    a = () => {
      d.map((c) => {
        c.current.innerHTML = "";
        ...
        m(!1),
        (P = ["", "", "", "", "", "", "", "", ""]),
        (k.current.innerHTML = "TicTacToe Game in <span> React</span>");
    };
  return Q.jsxs("div", {
    className:
      " text-center flex flex-col py-auto justify-center items-center h-screen",
    children: [
      Q.jsxs("h1", {
        className: " title text-white text-[35px] md:text-[60px]",
        ref: k,
        children: ["TicTacToe Game in ", Q.jsx("span", { children: " React" })],
      }),
      Q.jsxs("div", {
        className: "h-auto w-auto flex mt-[20px] gap-1",
        children: [
          Q.jsxs("div", {
      ...
      Q.jsx("button", {
        ...
        className:
          " place-self-center mt-[20px] px-12 py-3 border-none text-[20px] font-semibold capitalize rounded-full text-[#26ffcb] bg-[#1f3540]",
        children: "reset",
      }),
    ],
  });
...
function Md() {
  return Q.jsx(Q.Fragment, { children: Q.jsx(Dd, {}) });
}
Kl.createRoot(document.getElementById("root")).render(
  Q.jsx(Ec.StrictMode, { children: Q.jsx(Md, {}) })
);
